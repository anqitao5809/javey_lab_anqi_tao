...
def merge_sensors_with_physics(file1, file2, output_name="new_3-26_12-8-8_csv.csv"):
    try:
...
if __name__ == "__main__":
    file_a = "2026-03-26-14-26-10-N-0X-CH-UNIX BotSen_D10mmTop1288Bot.csv"
    file_b = "2026-03-26-14-26-24-N-1X-CH-UNIX TopSen_D10mmTop1288Bot.csv"
